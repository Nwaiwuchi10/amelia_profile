import about from "../../assets/images/enhancedT.jpeg";
      ...
      <div className="hero--section--content--box about--section--box">
        <div className="hero--section--content">
          ...
          <p className="hero--section-description">
            Amelia Clara Susan is a distinguished professional who has earned a
            certification validating their exceptional expertise in broker,
            cryptocurrencies, stock markets and the broader blockchain industry.
          </p>
          <p className="hero--section-description">
